...
class SettingsDialog(Gtk.Dialog):
    def __init__(self, parent: Optional[Gtk.Widget], visibility: Dict):
        ...
        tray_color_box = Gtk.Box(orientation=Gtk.Orientation.HORIZONTAL, spacing=6)
        tray_color_label = Gtk.Label(label=tr('tray_text_color'))
        tray_color_label.set_xalign(0)
        self.tray_color_combo = Gtk.ComboBoxText()
        self.tray_color_combo.append('default', tr('tray_color_default'))
        self.tray_color_combo.append('red', tr('tray_color_red'))
        self.tray_color_combo.append('green', tr('tray_color_green'))
        self.tray_color_combo.append('blue', tr('tray_color_blue'))
        self.tray_color_combo.append('yellow', tr('tray_color_yellow'))
        self.tray_color_combo.set_active_id(self.visibility_settings.get('tray_text_color', 'default'))
        tray_color_box.pack_start(tray_color_label, False, False, 0)
        tray_color_box.pack_start(self.tray_color_combo, False, False, 0)
        general_content.add(tray_color_box)
