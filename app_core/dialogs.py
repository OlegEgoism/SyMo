...
class SettingsDialog(Gtk.Dialog):
    def __init__(self, parent: Optional[Gtk.Widget], visibility: Dict):
        ...
        general_scroller.set_min_content_height(600)
        ...
        notification_scroller.set_min_content_height(600)
        ...
        logging_scroller.set_min_content_height(600)
        ...
        license_scroller.set_min_content_height(600)
        ...
        order_scroll.set_min_content_height(340)
