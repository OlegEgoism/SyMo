LANGUAGES = {
    'ru': {
        ...
        'menu_order_hint': 'Перетаскивайте пункты мышью для изменения порядка отображения.',
        'display_section': 'Отображение',
        'logging_section': 'Логи и графики',
        'notification_section': 'Уведомления',
        'graph_history_hint': 'Определяет, за сколько минут показываются данные на графиках.',
    ...
    'en': {
        ...
        'menu_order_hint': 'Drag items with the mouse to change display order.',
        'display_section': 'Display',
        'logging_section': 'Logs and charts',
        'notification_section': 'Notifications',
        'graph_history_hint': 'Controls how many minutes of data are shown in charts.',
    ...
    'cn': {
        ...
        'graph_history_hint': '控制图表中显示多少分钟的历史数据。',
        'menu_order_hint': '拖动项目以更改显示顺序。',
    ...
    'de': {
        ...
        'graph_history_hint': 'Legt fest, wie viele Minuten Daten in Diagrammen angezeigt werden.',
        'menu_order_hint': 'Ziehen Sie die Einträge mit der Maus, um die Anzeigereihenfolge zu ändern.',
    ...
    'it': {
        ...
        "menu_order_hint": "Trascina gli elementi con il mouse per cambiare l'ordine di visualizzazione.",
        'display_section': 'Visualizzazione',
        'logging_section': 'Log e grafici',
        'notification_section': 'Notifiche',
        'graph_history_hint': 'Definisce quanti minuti di dati mostrare nei grafici.',
    ...
    'es': {
        ...
        'menu_order_hint': 'Arrastra elementos con el ratón para cambiar el orden de visualización.',
        'display_section': 'Visualización',
        'logging_section': 'Registros y gráficos',
        'notification_section': 'Notificaciones',
        'graph_history_hint': 'Controla cuántos minutos de datos se muestran en los gráficos.',
    ...
    'tr': {
        ...
        'menu_order_hint': 'Görüntüleme sırasını değiştirmek için öğeleri fare ile sürükleyin.',
        'display_section': 'Görünüm',
        'logging_section': 'Günlükler ve grafikler',
        'notification_section': 'Bildirimler',
        'graph_history_hint': 'Grafiklerde kaç dakikalık verinin gösterileceğini belirler.',
    ...
    'fr': {
        ...
        "menu_order_hint": "Faites glisser les éléments avec la souris pour changer l'ordre d'affichage.",
        'display_section': 'Affichage',
        'logging_section': 'Journaux et graphiques',
        'notification_section': 'Notifications',
        'graph_history_hint': 'Définit le nombre de minutes de données affichées dans les graphiques.',
