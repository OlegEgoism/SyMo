    ...
    def show_settings(self, _w):
        ...
        try:
            ...
            if response == Gtk.ResponseType.OK:
                ...
                vs['cpu'] = info_visibility.get('cpu', dialog.cpu_check.get_active())
                vs['ram'] = info_visibility.get('ram', dialog.ram_check.get_active())
                vs['swap'] = info_visibility.get('swap', dialog.swap_check.get_active())
                vs['disk'] = info_visibility.get('disk', dialog.disk_check.get_active())
                vs['net'] = info_visibility.get('net', dialog.net_check.get_active())
                vs['uptime'] = info_visibility.get('uptime', dialog.uptime_check.get_active())
