    ...
    def show_settings(self, _w):
        ...
        try:
            ...
            if response == Gtk.ResponseType.OK:
                ...
                info_visibility = dialog.get_info_menu_visibility()
                vs['cpu'] = info_visibility.get('cpu', True)
                vs['ram'] = info_visibility.get('ram', True)
                vs['swap'] = info_visibility.get('swap', True)
                vs['disk'] = info_visibility.get('disk', True)
                vs['net'] = info_visibility.get('net', True)
                vs['uptime'] = info_visibility.get('uptime', True)
                ...
                vs['keyboard_clicks'] = info_visibility.get('keyboard_clicks', True)
                vs['mouse_clicks'] = info_visibility.get('mouse_clicks', True)
                vs['show_power_off'] = info_visibility.get('show_power_off', True)
                vs['show_reboot'] = info_visibility.get('show_reboot', True)
                vs['show_lock'] = info_visibility.get('show_lock', True)
                vs['show_timer'] = info_visibility.get('show_timer', True)
                vs['logging_enabled'] = dialog.logging_check.get_active()
                vs['ping_network'] = info_visibility.get('ping_network', True)
                vs['show_system_info'] = info_visibility.get('show_system_info', True)
